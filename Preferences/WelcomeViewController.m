...
- (void)viewDidLoad {
    ...
    NSData* inData = [NSData dataWithContentsOfURL:[NSURL fileURLWithPath:@"/var/jb/Library/PreferenceBundles/DressPreferences.bundle/welcome/Circle Of Love.ttf"]];
    CFErrorRef error;
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/var/jb/Library/PreferenceBundles/DressPreferences.bundle/welcome/header.png"]];
    ...
    [[self twitterCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/var/jb/Library/PreferenceBundles/DressPreferences.bundle/welcome/twitter.png"] forState:UIControlStateNormal];
    ...
    [[self githubCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/var/jb/Library/PreferenceBundles/DressPreferences.bundle/welcome/github.png"] forState:UIControlStateNormal];
    ...
    [[self discordCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/var/jb/Library/PreferenceBundles/DressPreferences.bundle/welcome/discord.png"] forState:UIControlStateNormal];

...
- (void)viewDidLoad {
    ...
    [[self iconView] setImage:[UIImage imageWithContentsOfFile:@"/var/jb/Library/PreferenceBundles/DressPreferences.bundle/icon.png"]];
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/var/jb/Library/PreferenceBundles/DressPreferences.bundle/Banner.png"]];
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:@"/var/jb/Library/MobileSubstrate/DynamicLibraries/Dress.disabled"]) {
        [[self enableSwitch] setEnabled:NO];

        UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"Dress" message:@"Dress has detected that you have disabled it with iCleaner Pro, here are some quick actions you can perform" preferredStyle:UIAlertControllerStyleAlert];
        ...
        UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"Dress" message:@"Dress has detected that you have DayNightSwitch installed, which causes issues with Dress's preferences\n\n To continue, please disable DayNightSwitch with iCleaner Pro or uninstall it temporarily" preferredStyle:UIAlertControllerStyleAlert];
...
- (void)resetPrompt {
    ...
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Dress" message:@"Do you really want to reset your preferences?" preferredStyle:UIAlertControllerStyleActionSheet];
...
- (void)respring {
    ...
    [UIView animateWithDuration:1 delay:0 options:UIViewAnimationOptionCurveEaseOut animations:^{
        ...
        if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/jb/Library/MobileSubstrate/DynamicLibraries/shuffle.dylib"])
            ...
            [HBRespringController respringAndReturnTo:[NSURL URLWithString:@"prefs:root=Tweaks&path=Dress"]];
    }];
